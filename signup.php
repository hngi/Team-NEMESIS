        ...
        <div class="row">
            ...
            <form method="post" action="signup.php">
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="email" class="form-control" id="exampleinputemail" aria-describedby="textHelp" required />
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary btn-block">
                        <a href="api.php">Signup with your twitter account</a>
                    </button>
                    <span>
    ...
    <!-- <div class="row">
        ...
        <div class="col-sm-6 second_column">
            ...
            <form method="post" action="signup.php">
                ...
                <button class="btn btn-primary"><a href="api.php">Sign up with your twitter account</a></button>
            </form>
        </div>
    </div> -->
</body>
