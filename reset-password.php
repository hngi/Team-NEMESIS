...
<p><a href="http://localhost/Team-NEMESIS-twitterbot/forgot-password/index.php">Click here</a> to reset password.</p>';
	}else{
...
$pass1 = md5($pass1);
mysqli_query($con,
"UPDATE `twitusers` SET `password`='".$pass1."', `trn_date`='".$curDate."' WHERE `email`='".$email."';");	

mysqli_query($con,"DELETE FROM `password_reset_temp` WHERE `email`='".$email."';");		
	
echo '<div class="error"><p>Congratulations! Your password has been updated successfully.</p>
<p><a href="http://localhost/Team-NEMESIS-twitterbot/forgot-password/login.php">Click here</a> to Login.</p></div><br />';
		}		
}
?>
